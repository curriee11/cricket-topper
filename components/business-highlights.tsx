        ...
        <div className="grid gap-6 xl:grid-cols-[0.95fr_1.05fr]">
          <div className="surface rounded-[32px] p-6 shadow-luxe sm:p-8">
            ...
            <div className="mt-6 grid gap-4">
              <div className="rounded-2xl border border-brand-500/15 bg-brand-50/60 p-4">
                ...
                <p className="mt-2 text-sm leading-6 text-slate-700">{ADDRESS}</p>
              </div>
              <div className="grid gap-4 sm:grid-cols-2">
                <div className="rounded-2xl border border-brand-500/15 bg-white/80 p-4">
                  ...
                  <p className="mt-2 text-sm leading-6 text-slate-700">{DISPLAY_PHONE}</p>
                </div>
                <div className="rounded-2xl border border-brand-500/15 bg-white/80 p-4">
                  <p className="text-xs uppercase tracking-[0.24em] text-slate-500">Hours</p>
          ...
          <div className="surface rounded-[32px] p-6 shadow-luxe sm:p-8">
            ...
            <div className="mt-4 flex flex-wrap items-end gap-4">
              <p className="text-5xl font-semibold text-slate-950">{GOOGLE_RATING}</p>
              <div className="pb-1">
